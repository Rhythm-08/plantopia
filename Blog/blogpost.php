...
<body>
    ...
    <?php
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <h1 style='font-size:42px;padding-bottom:5px;border-bottom:2px solid black;'>".$row['title']."</h1>
                    <p style='padding-bottom:20px;padding-top:10px;'>Posted on ".$row['date']."</p>
                   <center> <img src='../images/".$row['img']."' style='height:450px; width: 650px;border-radius:6px;' ></center>
                    <p style='text-align:justify;font-size:18px;padding-bottom:50px;padding-top:30px;' class= 'card-text text-truncate'>".$row['para']."</p> 
                    ";
                }
                } else {
                echo "0 results";
